...
#define START 0
#define TOKEN_READ_ 1 /* OCamlCC: TOKEN_READ -> TOKEN_READ_ */
...
/* OCamlCC: caml_parse_engine arguments as value (to remove CC warning) */

CAMLprim value old_caml_parse_engine(struct parser_tables *tables,
                                     struct parser_env *env, value cmd,
                                     value arg);

CAMLprim value caml_parse_engine(value tables, value env, value cmd, value arg){
  return old_caml_parse_engine((struct parser_tables *) tables,
                               (struct parser_env *) env, cmd, arg);
}
                                     ...
                                     value arg)
{
  ...
  case TOKEN_READ_: /* OCamlCC: TOKEN_READ -> TOKEN_READ_ */
    RESTORE;
    if (Is_block(arg)) {
...
/* OCamlCC: undef Short (conflicts with lexing.c) */
