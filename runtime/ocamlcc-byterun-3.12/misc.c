...
int caml_failed_assert (const char * expr, const char * file, int line)
{
...
char *caml_aligned_malloc (asize_t size, int modulo, void **block)
{
  ...
  *block = raw_mem;
  ...
  {
    uintnat *p;
    uintnat *p0 = (uintnat *) *block,
            *p1 = (uintnat *) (aligned_mem - modulo),
            *p2 = (uintnat *) (aligned_mem - modulo + size),
            *p3 = (uintnat *) ((char *) *block + size + Page_size);
